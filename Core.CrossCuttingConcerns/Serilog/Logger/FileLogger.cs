...
public class FileLogger:LoggerServiceBase
{
    ...
    public FileLogger(IConfiguration configuration)
    {
        ...
        //RollingInterval -> Ne kadar sürede bir yeni dosya oluştursun?
        //RetainedFileCountLimit -> Limit dosyalar buyudukce silinsin mi? Sınır
        //FileSizeLimitBytes -> 1 Dosya boyutu maksimum
        //OutputTemplate -> Dosyanın ismi ne olsun?
    }
